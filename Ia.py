...
class Ia(object):
    ...
    def __init__(self,input_dim,output_dim):
        ...
        self.reseau.add(keras.layers.Dense(18, activation='relu', input_shape=(1,)))
        ...
        self.reseau.add(keras.layers.BatchNormalization(momentum=0.8))
        #self.reseau.add(keras.layers.Dropout(0.2))
        #self.reseau.add(keras.layers.Conv2D(29, kernel_size=1, activation='relu'))
        #self.reseau.add(keras.layers.BatchNormalization(momentum=0.8))
        self.reseau.add(keras.layers.Dense(18, activation='relu'))
        self.reseau.add(keras.layers.BatchNormalization(momentum=0.8))

        self.reseau.add(keras.layers.Dense(9, activation='relu'))
        self.reseau.add(keras.layers.BatchNormalization(momentum=0.8))
        ...
        self.reseau.compile(loss=keras.losses.categorical_crossentropy,
